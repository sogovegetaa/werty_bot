...
function findBrowserExecutable(): string {
  ...
  if (process.env.PUPPETEER_EXECUTABLE_PATH) {
    ...
    throw new Error(
      `PUPPETEER_EXECUTABLE_PATH указан, но файл не найден: ${process.env.PUPPETEER_EXECUTABLE_PATH}`
    );
  }
  ...
  throw new Error(
    `Браузер не найден. Пожалуйста, установите Chromium или Chrome, либо укажите путь в переменной окружения PUPPETEER_EXECUTABLE_PATH.\n` +
